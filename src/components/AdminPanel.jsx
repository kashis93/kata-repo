...
import { Plus, Edit3, Trash2, Copy, RefreshCw, Car, DollarSign, Package, ShieldCheck, CheckCircle2, ShoppingBag, BarChart3, Download } from 'lucide-react';
...
export const AdminPanel = ({
  ...
  const handleExportCSV = () => {
    ...
    const headers = ['ID', 'Make', 'Model', 'Year', 'Price (INR)', 'Quantity', 'Body Type', 'Fuel Type', 'Horsepower', 'Top Speed', 'VIN'];
    ...
    link.href = url;
    link.setAttribute('download', `CariusX_Dealership_Inventory_${new Date().toISOString().split('T')[0]}.csv`);
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-6 bg-white border border-[#E5DCCF] rounded-3xl shadow-xs">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <button
            ...
            className="px-3.5 py-2 bg-[#F6F0E6] hover:bg-[#F2EBE1] text-[#1F1813] border border-[#E5DCCF] rounded-full text-xs font-bold transition-colors flex items-center gap-1.5 cursor-pointer"
